...
import HealthService from "../img/HealthService.jpg";
    ...
    return(
        ...
        <div className="flex justify-center">
            <div className=" bg-[#a2c5eb71] shadow-xl w-[200px] md:w-[500px] p-5 md:p-10 md:mt-[-5rem]">
                <p className="text-xs md:text-xl line-clamp-5 md:line-clamp-none">
                    ...
                    We want to make sure you have all the facts you need to make an educated decision.
                </p>
            </div>
        </div>
